...
with h5py.File('/home/anthonyp57/VSCode_projects/Spectra_transfer/git_code/ACVAE/new_data/spectra.h5', 'r') as hf:
    ...
    v100_1 = all_spectra[v100_1]
    v100_7 = all_spectra[v100_7]
    v100_17 = all_spectra[v100_17]
    v100_40 = all_spectra[v100_40]

    e50_1 = all_spectra[e50_1]
    e50_7 = all_spectra[e50_7]
    e50_17 = all_spectra[e50_17]
    e50_40 = all_spectra[e50_40]

    e100_1 = all_spectra[e100_1]
    e100_7 = all_spectra[e100_7]
    e100_17 = all_spectra[e100_17]
    e100_40 = all_spectra[e100_40]
...
def calc_kmeans_loss(tr_spectra):
    tr_spectra = pca.transform(tr_spectra)
    tr_labels = kmeans.fit_predict(tr_spectra)

    best_match = map_labels(labels_.reshape(-1, )[:len(tr_spectra)], tr_labels.reshape(-1, ))
    score = accuracy_score(labels_.reshape(-1, )[:len(tr_spectra)], best_match.reshape(-1, ))
    score_loss = 1-score

    return score, score_loss
